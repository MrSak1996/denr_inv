        ...
        <div class="flex flex-wrap justify-between gap-5">
          <div>
            ...
            ><span class="mt-1.5 block"
              ><span class="font-medium text-black dark:text-white">Address:</span> 2972 Westheimer
              Rd. Santa Ana.</span
            >
          </div>
          <div>
            ...
            <a href="#" class="block"
              ...
              contact@example.com</a
            ><span class="mt-1.5 block"
              ><span class="font-medium text-black dark:text-white">Address:</span> New York, USA
              2707 Davis Anenue</span
            >
          </div>
        </div>
        <div
          ...
          <div class="max-w-full overflow-x-auto">
            <div class="min-w-[670px]">
              ...
              <div
                class="grid grid-cols-12 border-b border-stroke py-3.5 pl-5 pr-6 dark:border-strokedark"
              >
                <div class="col-span-3"><p class="font-medium">Techno</p></div>
                <div class="col-span-4"><p class="font-medium">Kemon 24 smart phone</p></div>
                <div class="col-span-2"><p class="font-medium">1</p></div>
                <div class="col-span-2"><p class="font-medium">$200</p></div>
                <div class="col-span-1"><p class="text-right font-medium">$200</p></div>
              </div>
              <div
                class="grid grid-cols-12 border-b border-stroke py-3.5 pl-5 pr-6 dark:border-strokedark"
              >
                <div class="col-span-3"><p class="font-medium">Vivo</p></div>
                <div class="col-span-4"><p class="font-medium">Vivo 32 smart phone</p></div>
                <div class="col-span-2"><p class="font-medium">3</p></div>
                <div class="col-span-2"><p class="font-medium">$300</p></div>
                <div class="col-span-1"><p class="text-right font-medium">$900</p></div>
              </div>
              <div
                class="grid grid-cols-12 border-b border-stroke py-3.5 pl-5 pr-6 dark:border-strokedark"
              >
                <div class="col-span-3"><p class="font-medium">Samsung</p></div>
                <div class="col-span-4"><p class="font-medium">S23 Ultra</p></div>
                <div class="col-span-2"><p class="font-medium">1</p></div>
                <div class="col-span-2"><p class="font-medium">$1300</p></div>
                <div class="col-span-1"><p class="text-right font-medium">$1300</p></div>
              </div>
              <div
                class="grid grid-cols-12 border-b border-stroke py-3.5 pl-5 pr-6 dark:border-strokedark"
              >
                <div class="col-span-3"><p class="font-medium">Apple</p></div>
                <div class="col-span-4"><p class="font-medium">iPhone 15Pro Max</p></div>
                <div class="col-span-2"><p class="font-medium">2</p></div>
                <div class="col-span-2"><p class="font-medium">$1200</p></div>
                <div class="col-span-1"><p class="text-right font-medium">$2400</p></div>
              </div>
              <div
                class="grid grid-cols-12 border-b border-stroke py-3.5 pl-5 pr-6 dark:border-strokedark"
              >
                <div class="col-span-3"><p class="font-medium">Oppo</p></div>
                <div class="col-span-4"><p class="font-medium">Fold X</p></div>
                <div class="col-span-2"><p class="font-medium">1</p></div>
                <div class="col-span-2"><p class="font-medium">$900</p></div>
                <div class="col-span-1"><p class="text-right font-medium">$900</p></div>
              </div>
            </div>
          </div>
          <div class="flex justify-end p-6">
            <div class="w-full max-w-65">
              <div class="flex flex-col gap-4">
                ...
                <p class="flex justify-between font-medium text-black dark:text-white">
                  <span> Shipping Cost (+) </span><span> $10.00 </span>
                </p>
                <p class="flex justify-between font-medium text-black dark:text-white">
                  <span> Coupon Discount <span class="text-meta-3">(10%)</span></span
                  ><span> $470 </span>
                </p>
                <p class="flex justify-between font-medium text-black dark:text-white">
