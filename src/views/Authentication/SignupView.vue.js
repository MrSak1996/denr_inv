...
// @ts-ignore
const __VLS_7 = __VLS_asFunctionalComponent(DefaultAuthCard, new DefaultAuthCard({
    subtitle: "Start for free",
    title: "Sign Up to TailAdmin",
}));
...
/** @type {__VLS_StyleScopedClasses['dark:hover:bg-opacity-80']} */ ;
/** @type {__VLS_StyleScopedClasses['mt-6']} */ ;
