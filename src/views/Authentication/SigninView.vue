...
<template>
  ...
  <div v-if="openLoginForm" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50"
    role="dialog" aria-labelledby="reserve-control-no" aria-modal="true">
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
      <DefaultAuthCard subtitle="Department of Environment and Natural Resources"
        ...
        <form @submit.prevent="loginUser">
          ...
          <InputGroup v-model="form.password" label="Password" type="password" placeholder="Password">
            <svg class="fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <g opacity="0.5">
                <path
          ...
          <div class="mb-5 mt-6 flex justify-between gap-4">
            <input type="button" value="Cancel" @click="closeLogin"
          ...
          <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
              ...
              <div class="flex items-center lg:order-2">
                <a @click="openLogin"
                  class="text-white bg-teal-700 hover:bg-teal-900 focus:ring-4 focus:ring-teal-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-teal-600 dark:hover:bg-teal-700 focus:outline-none dark:focus:ring-teal-800">Sign-in</a>
              ...
              <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <ul role="list" class="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                  <li class="flex space-x-3">
                    ...
                    <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">Asset
                      Management</span>
                  </li>
                  <li class="flex space-x-3">
                    <svg class="flex-shrink-0 w-5 h-5 text-teal-500 dark:text-teal-400" fill="currentColor"
                  ...
                  <li class="flex space-x-3">
                    ...
                    <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">User & Role
                      Management</span>
                  </li>
                  <li class="flex space-x-3">
                    <svg class="flex-shrink-0 w-5 h-5 text-teal-500 dark:text-teal-400" fill="currentColor"
                    ...
                    <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">Mobile & Web
                      Access</span>
                  </li>
                </ul>
                <p class="mb-8 font-light lg:text-xl">
