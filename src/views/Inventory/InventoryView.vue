      ...
      <div
        ...
        <DataTable size="small" v-model:expandedRows="expandedRows" :filters="filters" @rowExpand="onRowExpand"
          ...
          <Column field="id" header="Action">
            <template #body="{ data }">
              <div class="card flex justify-center">
                ...
                <Button v-if="!data.file_id" @click="openModal(data.id)" icon="pi pi-cloud-upload" size="small"
                  class="text-white mr-2 bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" />
          ...
          <Column field="qr_code" header="ICT Equipment QR Code" style="min-width: 12rem; text-align: center;">
            <template #body="{ data }">
              <div class="flex justify-center items-center h-24">
                <QrcodeVue v-if="data.qr_code && data.qr_code.trim() !== ''" :value="data.qr_code" :size="50" />
              </div>
          ...
          <Column field="ups_qr_code" header="UPS QR Code" style="min-width: 12rem">
            <template #body="{ data }">
              <QrcodeVue v-if="data.ups_qr_code && data.ups_qr_code.trim() !== ''" :value="data.ups_qr_code" :size="50"
                class="text-center" />
              {{ data.ups_qr_code }}
