...
watch(
  () => props.total_unserviceable_count,
  (newValue) => {
    ...
    <div class="bg-white rounded-lg shadow-lg border border-gray-200">
      ...
      <div class="grid grid-cols-4 gap-4 p-6">
        ...
        <div class="flex flex-col gap-4 col-span-1">
          ...
          <div :class=" office === 'CENRO Sta. Cruz' ? 'bg-teal-700 flex items-center justify-between gap-4 rounded-lg shadow p-2 border border-teal-500 text-white' : 'hidden' " >
          ...
          <div :class=" office === 'CENRO Lipa City' ? 'bg-teal-700 flex items-center justify-between gap-4 rounded-lg shadow p-2 border border-teal-500 text-white' : 'hidden' " >
          ...
          <div :class=" office === 'CENRO Calaca' ? 'bg-teal-700 flex items-center justify-between gap-4 rounded-lg shadow p-2 border border-teal-500 text-white' : 'hidden' " >
          ...
          <div :class=" office === 'CENRO Calauag' ? 'bg-teal-700 flex items-center justify-between gap-4 rounded-lg shadow p-2 border border-teal-500 text-white' : 'hidden' " >
          ...
          <div :class=" office === 'CENRO Catanauan' ? 'bg-teal-700 flex items-center justify-between gap-4 rounded-lg shadow p-2 border border-teal-500 text-white' : 'hidden' " >
            <i class="pi pi-map-marker text-2xl" style="font-size: 30px"></i>
            <div class="text-left">
          ...
          <div :class=" office === 'CENRO Tayabas' ? 'bg-teal-700 flex items-center justify-between gap-4 rounded-lg shadow p-2 border border-teal-500 text-white' : 'hidden' " >
            <i class="pi pi-map-marker text-2xl" style="font-size: 30px"></i>
            <div class="text-left">
           ...
           <div :class=" office === 'CENRO Real' ? 'bg-teal-700 flex items-center justify-between gap-4 rounded-lg shadow p-2 border border-teal-500 text-white' : 'hidden' " >
        ...
        <div class="grid grid-cols-3 gap-4 col-span-3">
          ...
          <div class="flex flex-col gap-4">
            <div :class=" office === 'PENRO Cavite' ? 'bg-teal-700 flex items-center justify-between gap-4 rounded-lg shadow p-2 border border-teal-500 text-white' : 'hidden' " >
            ...
            <div :class=" office === 'PENRO LAGUNA' ? 'bg-teal-700 flex items-center justify-between gap-4 rounded-lg shadow p-2 border border-teal-500 text-white' : 'hidden' " >
            ...
            <div :class=" office === 'PENRO BATANGAS' ? 'bg-teal-700 flex items-center justify-between gap-4 rounded-lg shadow p-2 border border-teal-500 text-white' : 'hidden' " >
            ...
            <div :class=" office === 'PENRO RIZAL' ? 'bg-teal-700 flex items-center justify-between gap-4 rounded-lg shadow p-2 border border-teal-500 text-white' : 'hidden' " >
            ...
            <div :class=" office === 'PENRO QUEZON' ? 'bg-teal-700 flex items-center justify-between gap-4 rounded-lg shadow p-2 border border-teal-500 text-white' : 'hidden' " >
            ...
            <div :class=" office === 'Regional Office' ? 'bg-teal-700 flex items-center justify-between gap-4 rounded-lg shadow p-2 border border-teal-500 text-white' : 'hidden' " >
