...
<template>
  <aside
    ...
    :class="{
      'w-[260px]': !sidebarStore.isSidebarCollapsed,
      'w-25': sidebarStore.isSidebarCollapsed,
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
      <img src="@/assets/images/logo/denr_logo.png" alt="Logo" class="h-8 w-10" />
      <transition name="fade">
        <span v-if="!sidebarStore.isSidebarCollapsed" class="text-xl font-semibold whitespace-nowrap">
          &nbsp;DENR IV-A <br />
          ({{ userRole }})
        </span>
      </transition>
