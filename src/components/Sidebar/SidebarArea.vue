...
const menuGroups = ref([
  {
    ...
    menuItems: [
      ...
      },
      {
        ...
        route: '#',
        children:[
          { label: 'ICT Equipment',route:'/inventory' },
          { label: 'Create ICT Equipment',route:'/inventory/create' },
          { label: 'Generate Reports',route:'/ecommerce'},
          { label: 'Inventory Transactions',route:'/ecommerce'},
      ...
      //   route: '#',
      //   children: [
      //     // { label: 'Create', route: '/survey-request/create' },
      //     { label: 'Survey Form List', route: '/survey-request/view' }
      //   ]
