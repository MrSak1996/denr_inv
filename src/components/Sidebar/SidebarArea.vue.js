...
const historyIcon = `<i class='pi pi-history'></i>`;
const importIcon = `<i class='pi pi-file-import'></i>`;
const menuGroups = ref([
    {
        ...
        menuItems: [
            ...
            // },
            {
                icon: dashboardIcon,
                label: 'Dashboard',
                route: `/inventory?id=${userId}&api_token=${api_token}`
            },
            {
                icon: historyIcon,
                label: 'History Logs',
                route: `/inventory/logs?id=${userId}&api_token=${api_token}`
            },
            {
                icon: inventoryIcon,
                label: 'Summary',
    ...
    return menuGroups.value.map((group) => {
        return {
            ...
            menuItems: group.menuItems.filter((menuItem) => {
                if (menuItem.label === 'User Management' &&
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.aside, __VLS_intrinsicElements.aside)({
    ...
    ...{ class: ({
            'w-[260px]': !__VLS_ctx.sidebarStore.isSidebarCollapsed,
            'w-25': __VLS_ctx.sidebarStore.isSidebarCollapsed,
            'translate-x-0': __VLS_ctx.sidebarStore.isSidebarOpen,
            '-translate-x-full': !__VLS_ctx.sidebarStore.isSidebarOpen
        }) },
    ref: "target",
});
...
for (const [menuGroup] of __VLS_getVForSourceType((__VLS_ctx.filteredMenuGroups))) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
    __VLS_asFunctionalElement(__VLS_intrinsicElements.ul, __VLS_intrinsicElements.ul)({
        ...{ class: "mb-6 flex flex-col gap-1.5" },
    });
    for (const [menuItem, index] of __VLS_getVForSourceType((menuGroup.menuItems))) {
...
/** @type {__VLS_StyleScopedClasses['py-5.5']} */ ;
/** @type {__VLS_StyleScopedClasses['lg:py-6.5']} */ ;
...
/** @type {__VLS_StyleScopedClasses['lg:mt-9']} */ ;
